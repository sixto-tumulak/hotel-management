...
<body>
    ...
    <nav class="sidenav">
       <ul>
           ...
           <li class="pagebtn"><img src="../image/icon/bed.png" alt="Room Booking">&nbsp;&nbsp;&nbsp;Room Booking</li>
           <li class="pagebtn"><img src="../image/icon/wallet.png" alt="Payment">&nbsp;&nbsp;&nbsp;Payment</li>            
